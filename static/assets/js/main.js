...
if(window.location.pathname === "/index.html" || window.location.pathname === "/") {
  ...
  const options = ["Right-Click to access more features", "Tab Cloaking is highly recommended", "About:Blank Cloak is highly recommended", "This site was originally created as a joke", "Hosted on the best hardware!", "Do not share this link with anyone.", "Join our Discord for more cool things!", "Join our Discord for more cool things!", "© Copyright 2025 Unlocked Joy. All Rights Reserved.", ];
